#!/bin/bash
#Lists all the friends of whoever's graph api friends with access token has been used as $url and saves it to a file friends.txt
...
echo $user_name
filename=$user_name"friends.txt"
